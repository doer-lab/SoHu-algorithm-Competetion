...
def html_filter(content):
    ...
    s4 = html.unescape(s3)
    s5 = str_q2b(s4).replace('\xc2\xa0', ' ')
    content_txt = multi_space_pat.sub(' ', s5).strip()
    return content_txt


def html_filter_file(fin, fout_):
    fout = open(fout_, 'w', encoding='utf8')
    for raw_line in open(fin, encoding='utf8'):
...
def usage():
    ...
    ./tools3.py --method <method> --source <source_file> --target <target_file> --filtered <filtered_file>
    or for short,
    ./tools3.py -m <method> -s <source_file> -t <target_file> -f <filtered_file>
    ...
    filter:
        ./tools3.py -m filter -s News_info_train_example100.txt -t News_info_train_example100_filter.txt
    eval:
        ./tools3.py -m eval -s Your_label_example100.txt -t News_pic_label_train_example100.txt -f News_info_train_example100_filter.txt
    ''')
    return
